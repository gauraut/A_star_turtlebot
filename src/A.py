...
def DS(node, goal, L,ga):
	...
	while Q:
		...
		CL.append(cn.d)
		print(cn.d[0],cn.d[1])
		# am[249-round(cn.d[1])][round(cn.d[0])] = [255,255,255]
		cv2.arrowedLine(am, (round(cn.pxy[0]), round(249-cn.pxy[1])), (round(cn.d[0]), round(249-cn.d[1])),(255,255,255), 1, 1, 0, 0.1)
...
def get_input():
	...
	return [10,10],[399-10,249-10],5,0,0
